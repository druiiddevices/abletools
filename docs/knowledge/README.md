# Abletools knowledge routing

These files are the canonical asset and style references shared by the Abletools GPT and repository agents.

| Request | Required files |
|---|---|
| Any asset | `KNOWLEDGE_ABLETON_ASSET_STANDARDS_R1.md` |
